...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>CSM</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CSMExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.csm"));
				ActiveResourceType root = CSMFactory.eINSTANCE.createActiveResourceType();
