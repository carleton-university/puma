 ...
 * <!-- end-user-doc -->
 * @see ca.carleton.sce.puma.CSM.CSMPackage#getPerfAttribute()
 * @model extendedMetaData="name='PerfAttribute'"
 * @generated
 */
public enum PerfAttribute implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<PerfAttribute> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
